...
Git-cloning the repository, unzip the `guy.mcdooooo.tipop-iphone-1.0.5.zip` package and put the `modules/iphone/guy.mcdooooo.tipop` into the `modules/iphone` folder of your project. 
