...
NSString * const kPOPLayerRotation3D = @"rotation3D";
...
static POPStaticAnimatablePropertyState _staticStates[] =
{
  ...
  {kPOPLayerRotation3D,
    ^(CALayer *obj, CGFloat values[]) {
      values_from_rect(values, POPLayerGetRotation3D(obj));
    },
    ^(CALayer *obj, const CGFloat values[]) {
      POPLayerSetRotation3D(obj, CGRectMake(values[0], values[1], values[2], -1));
    },
    kPOPThresholdRotation
  },
