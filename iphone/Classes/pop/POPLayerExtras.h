...
/**
 @abstract Returns layer rotation, in radians, 3-Dimensions.
 */
extern CGRect POPLayerGetRotation3D(CALayer *l);

/**
 @abstract Sets layer rotation, in radians, 3-Dimensions.
 */
extern void POPLayerSetRotation3D(CALayer *l, CGRect p);
